...
import { data as appointments } from '../demo-data/demo-data';

const resources = [{
  fieldName: 'priorityId',
  title: 'Priority',
  instances: [
    { text: 'x akedemisyen', id: 1, color: blue },
    { text: 'y akedemisyen', id: 2, color: orange },
    { text: 'z akedemisyen', id: 3, color: pink },
